...
4. [Financial Accounting (FI)](#4-financial-accounting-fi)
5. [Materials Management (MM)](#5-materials-management-mm)
6. [Sales and Distribution (SD)](#6-sales-and-distribution-sd)
7. [Customization Steps](#7-customization-steps)
8. [Transaction Code Reference](#8-transaction-code-reference)
9. [Master Data Configuration](#9-master-data-configuration)
10. [Integration Configuration](#10-integration-configuration)
11. [Test Scenarios](#11-test-scenarios)
12. [Reports Configuration](#12-reports-configuration)
...
| Engineering Solutions | Custom prototypes | 15% |
...
#### Company Code 1000 Configuration
...
#### Plant Configuration (PL01 - Mumbai)
...
|------|---------|
| **Made by** | **Sagnik Das** |
| **Enrollment Number** | **23051213** |
| **Phone** | **7384734236** |
| **Email** | **23051213@kiit.ac.in** |
